...
repository](https://github.com/IBM/tensorflow-hangul-recognition).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/tensorflow-hangul-recognition/issues). Before
embarking on a more ambitious contribution, please quickly [get in touch](#communication)
with us.
...
issue](https://github.com/IBM/tensorflow-hangul-recognition/issues) before sending
a pull request so the feature can be discussed. This is to avoid you spending your
...
issue](https://github.com/IBM/tensorflow-hangul-recognition/issues) before sending
a pull request so it can be discussed. If the fix is trivial or non controversial
then this is not usually necessary.
...
Please feel free to connect with us: [here](https://github.com/IBM/tensorflow-hangul-recognition/issues)
